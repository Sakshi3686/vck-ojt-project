...
const ContactPage = () => {
    return(
        <div>
            ...
            <div className="main3">
                <div className="main4">
            <h1 id="myid2">Contact Us</h1>
            <p id="myid3">We'd love to hear from you! Whether you have questions about admissions, programs, or campus life, our team is here to help.</p>
            <h2 id="h2">General enqires</h2>
            <p><b>Vivekanand College Main Campus</b></p>
            <p>[Mahatma Gandhi Road, Chembur, Mumbai, Maharashtra 400071]</p>
            <p>India</p>
            <p id="myid3">Phone: +91 12345 67890</p>
            <p>Email: info@vivekanandcollege.edu</p>
            <p>Office Hours: Monday - Friday, 9:00 AM - 5:00 PM IST</p>
            <h2 id="h2">Admissions Office</h2>
            ...
            <h2 id="h2">Student Support Services</h2>
            <p>For current student support, academic advising, or general assistance</p>
            <p>Phone: +91 87654 32109</p>
            <p>Email: studentsupport@vivekanandcollege.ed</p>
            <h2 id="h2">Find Us on the Map</h2>
